...
saveRDS(ipw_cox_hospitalization,paste0(path_pasc_diabetes_folder,"/working/sensitivity utilization/pdsu401_ipw cox hospitalization.RDS"))
...
bind_rows(
  ...
  write_csv(.,"sensitivity utilization/pdsu401_coefficients from ip weighted survival analysis.csv")
