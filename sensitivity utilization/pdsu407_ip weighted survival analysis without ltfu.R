...
saveRDS(ipw_cox_fit,paste0(path_pasc_diabetes_folder,"/working/sensitivity utilization/pdsu407_ipw cox fit.RDS"))
saveRDS(overlap_cox_fit,paste0(path_pasc_diabetes_folder,"/working/sensitivity utilization/pdsu407_overlap cox fit.RDS"))
saveRDS(ipw_cox_sex,paste0(path_pasc_diabetes_folder,"/working/sensitivity utilization/pdsu407_ipw cox sex.RDS"))
saveRDS(ipw_cox_raceeth,paste0(path_pasc_diabetes_folder,"/working/sensitivity utilization/pdsu407_ipw cox raceeth.RDS"))
saveRDS(ipw_cox_age,paste0(path_pasc_diabetes_folder,"/working/sensitivity utilization/pdsu407_ipw cox age.RDS"))
saveRDS(ipw_cox_hospitalization,paste0(path_pasc_diabetes_folder,"/working/sensitivity utilization/pdsu407_ipw cox hospitalization.RDS"))
...
bind_rows(
  ...
  write_csv(.,"sensitivity utilization/pdsu407_coefficients from ip weighted survival analysis.csv")
