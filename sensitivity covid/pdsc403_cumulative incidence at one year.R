...
ipw_cox_sex <- coxph(as.formula(paste0("Surv(t, incident_dm) ~ COHORT_sex_category + ",
                                       paste0(imbalanced_variables,collapse="+"),
                                       "+",
                                       paste0(covid_variables,collapse=" + "))), 
...
ipw_cox_age <-  coxph(as.formula(paste0("Surv(t, incident_dm) ~ COHORT_age_category + ",
                                        paste0(imbalanced_variables,collapse="+"),
                                        "+",
                                        paste0(covid_variables,collapse=" + "))), 
...
surv_probs %>%
  ...
  write_csv(.,"sensitivity covid/pdsc403_cumulative incidence at one year.csv")
